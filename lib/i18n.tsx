...
const translations = {
  ...
  demoKeyUp: { ja: "↑ 上 (Up)", en: "↑ Up", es: "↑ Arriba" },
  demoKeyDown: { ja: "↓ 下 (Down)", en: "↓ Down", es: "↓ Abajo" },
  demoKeyLeft: { ja: "← 左 (Left)", en: "← Left", es: "← Izquierda" },
  demoKeyRight: { ja: "→ 右 (Right)", en: "→ Right", es: "→ Derecha" },
  demoKeyJump: { ja: "Space ジャンプ (Jump)", en: "Space Jump", es: "Space Saltar" },
